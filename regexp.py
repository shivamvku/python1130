...
# # # Used to searchthe cahrecters
# # # --------------------------------------------
# # # . - Any char excpt a new line
# # # \d - digits(0-9)
# # # \D - not a digt (0-9)
...
# # \s - white space(sapce ,tabs, newline)
...
# # $ -- used at end the string

# # ----------------------------------------------------------------


# searching a group of char
# =====================================

# # []--------------- > matech the char in the brackets
# # [^ ]-------------> math the char other in the brackets


# # Flags----- it is modifier
...
# (staring vale,final value) -- used in groups
...
# ?  ------ used 0 or more
# {7}   -           exact number 
# {min vale,max value}   -  ranges of number in the brackets    
...
doc = '''Form 4868, Application for Automatic Extension of Time To File U.S. Individual Income Tax Return 
...
# # a = re.complile(r'expression)

# a = re.compile(r'\d\d\d\*\d\d\d\*\d\d\d\d')
# match = a.finditer(doc)
...
import re
tup = re.findall(r'([\w\.-]+)@([\w\.-]+)',doc)
# print(tup)
# for a in tup:
    # print(tup[0])
    # print(tup[1])

print(re.sub(r'([\w\.]+)@([\w\.]+)',r'\1@digitallync.com',doc))
